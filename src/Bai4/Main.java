...
public class Main {
    public static void main(String[] args) {
        ...
        ChuyenXeNoiThanh CXNoT2 = new ChuyenXeNoiThanh(4, 130, "MS124", "Nguyen thien thua", 59131575, 2400000);
        ChuyenXeNoiThanh CXNoT3 = new ChuyenXeNoiThanh(5, 150, "MS125", "Đặng tấn Tín", 59131575, 2500000);
        ChuyenXeNgoaiThanh CXNgT1 = new ChuyenXeNgoaiThanh("Nha Trang", 4, "MS126", "Nguyễn Tấn Thi", 483833, 1000000);
        ChuyenXeNgoaiThanh CXNgT2 = new ChuyenXeNgoaiThanh("Huế", 4, "MS127", "Le Xuan Trung", 483833, 1000000);
        ChuyenXeNgoaiThanh CXNgT3 = new ChuyenXeNgoaiThanh("Đà Nẵng", 4, "MS128", "Nguyễn Tấn Kiet", 483833, 1000000);
