...
public class Main {
    public static void main(String[] args) {
        ...
        ChuyenXeNoiThanh CXNoT2 = new ChuyenXeNoiThanh(4, 130, "MS124", "Đặng Quang Qua", 59131575, 2400000);
        ...
        ChuyenXeNgoaiThanh CXNgT2 = new ChuyenXeNgoaiThanh("Huế", 4, "MS127", "Nguyễn Tấn Thi", 483833, 1000000);
        ChuyenXeNgoaiThanh CXNgT3 = new ChuyenXeNgoaiThanh("Đà Nẵng", 4, "MS128", "Nguyễn Tấn Thi", 483833, 1000000);
